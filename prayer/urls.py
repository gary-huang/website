...
urlpatterns = [
    ...
    path('mv-to-jar/<str:pr_id>', views.prayer_request_mv_to_jar, name='mv-to-jar-prayer-request'),
    path('rm-from-jar/<str:pr_id>', views.prayer_request_rm_from_jar, name='rm-from-jar-prayer-request'),
]
